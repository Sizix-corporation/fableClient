<template>
  <nav
    class="flex justify-around gap-x-2 w-full m-0 md:p-4 text-slate-900 dark:text-white"
  >
    <div class="flex flex-row items-center gap-x-4 justify-start lg:w-full">
      <NuxtLink
        to="/"
